...
| **allureAddTags**<br/>_type: boolean_<br/>_default: true_                                                                                                                                                                           | Whether to show add tags to report specified in tests title or in cypress test config object (excluding special tags like `issue`,`tms`, etc                                                                                                                                                                                                                                                                                                                                                                  |
