...
|---------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **allure**<br/>_default: false_                   | Enables reporting                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | boolean: true/false                                                                                                                                                                                                                      |
| **allureResults**<br/>_default: `allure-results`_ | Path to allure results                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | string: `allure-results`                                                                                                                                                                                                                 |
| **allureResultsWatchPath**                        | This is needed when using Allure TestOps: <br/>path to folder where results will be moved after all tests from spec are executed. <br/>This path is what you need to watch when using Allure TestOps, but default this is not specified. When you use this path test results will start to appear in Allure TestOps only after spec is finished. <br/>If do not use this with Allure TestOps some videos may not be uploaded - videos will be uploaded only for 1 test from spec file. | string: `allure-results/watch`                                                                                                                                                                                                           |
| **allureLogCyCommands**<br/>_default: true_       | log cypress commands, by default will log                                                                                                                                                                                                                                                                                                                                                                                                                                              | boolean: true/false                                                                                                                                                                                                                      |
| **allureSkipCommands**                            | Will not log specified commands as steps in allure report, by default logs all commands                                                                                                                                                                                                                                                                                                                                                                                                | string - command separated with comma: `screenshot,wait`                                                                                                                                                                                 |
| **allureWrapCustomCommands**<br/>_default: true_  | will wrap custom commands, so custom command will have child steps in report<br/>When value has string with commands split by comma will wrap only these commands. <br/>To exclude commands specify them starting with `!`                                                                                                                                                                                                                                                             | boolean: true/false/string<br/> - Wrap all custom commands: `true`<br/> - Wrap only following custom commands: `myCutomCmd,interceptSpecial`<br/> - Wrap  all custom commands except following commands: `!myCutomCmd,!interceptSpecial` |
| **allureCleanResults**<br/>_default: false_       | Will remove allure results on cypress start (it will be done once, after plugins are loaded)                                                                                                                                                                                                                                                                                                                                                                                           | boolean: true/false                                                                                                                                                                                                                      |
| **allureAttachRequests**<br/>_default: false_     | Attach request/response body and status as files to request step                                                                                                                                                                                                                                                                                                                                                                                                                       | boolean: true/false                                                                                                                                                                                                                      |
| **allureCompactAttachments**<br/>_default: true_  | Stringify requests attachments with spaces or not                                                                                                                                                                                                                                                                                                                                                                                                                                      | boolean: true/false                                                                                                                                                                                                                      |
| **allureAddVideoOnPass**<br/>_default: false_     | When true - will attach video for all tests (including passed), otherwise will attach videos only for failed, broken, unknown                                                                                                                                                                                                                                                                                                                                                          | boolean: true/false                                                                                                                                                                                                                      |
| **tmsPrefix**                                     | You can specify prefix to tms using this.  <br/>Also link can be specified with `*` - it will be replced with id.                                                                                                                                                                                                                                                                                                                                                                      | string: `http://jira.com` or `http://jira.com/PROJECT-1/*/browse`                                                                                                                                                                        |
| **issuePrefix**                                   | The same as tmsPrefix - for issue                                                                                                                                                                                                                                                                                                                                                                                                                                                      | string: `http://jira.com` or `http://jira.com/PROJECT-1/*/browse`                                                                                                                                                                        |
| **allureShowDuplicateWarn**<br/>_default: false_  | Show console warnings about test duplicates.                                                                                                                                                                                                                                                                                                                                                                                                                                           | boolean: true/false                                                                                                                                                                                                                      |
