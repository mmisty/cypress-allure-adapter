...
| **allureSkipCommands**<br/>_type: string_<br/><br/>ex.: `screenshot,wait` <br/>ex.: `"after each" hook*,"before each" hook*`                                                                                                        | Commands separated with comma<br/>Will not log specified commands as steps in allure report, by default logs all commands.To skip before each or after each hooks their names can be aaded here as well. You can also use asterisk if you want to exclude all before each/after each hooks even those who have names<br/>                                                                                                                                                              |
